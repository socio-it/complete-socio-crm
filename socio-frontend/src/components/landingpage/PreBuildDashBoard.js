      ...
      <Grid container spacing={7.5} justifyContent="center" sx={{ px: 1.25 }}>
          ...
          <Grid container spacing={1.5}>
            <Grid item xs={12}>
              <Typography variant="h2" sx={{ fontSize: { xs: '1.5rem', sm: '2.125rem' } }}>
                <FormattedMessage id="explore-conceptual-apps" />
              </Typography>
            </Grid>
            <Grid item xs={12}>
              <Typography variant="h4" sx={{ fontWeight: 400 }} align="center">
                <FormattedMessage id="conceptual-apps-description" />
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        <Grid item xs={12}>
          ...
          >
            ...
            >
              <Items
                title={<FormattedMessage id="mail-app" />}
                image={theme.palette.mode === ThemeMode.DARK ? SliderDark5 : SliderLight5}
                link="/apps/mail"
              />
              <Items title={<FormattedMessage id="chat-app" />} image={theme.palette.mode === ThemeMode.DARK ? SliderDark3 : SliderLight3} link="/apps/chat" />
              <Items
                title={<FormattedMessage id="kanban-app" />}
                image={theme.palette.mode === ThemeMode.DARK ? SliderDark4 : SliderLight4}
                link="/apps/kanban/board"
              />
              <Items
                title={<FormattedMessage id="calendar-app" />}
                image={theme.palette.mode === ThemeMode.DARK ? SliderDark2 : SliderLight2}
                link="/apps/calendar"
              />
              <Items
                title={<FormattedMessage id="ecommerce-app" />}
                image={theme.palette.mode === ThemeMode.DARK ? SliderDark1 : SliderLight1}
                link="/apps/e-commerce/products"
              />
              <Items
                title={<FormattedMessage id="social-profile-app" />}
